  ...
  (() => {
    ...
    t.r(e),
      t.d(e, {
        ...
        Parallax: () => me,
        ParticlesBounce: () => Fe,
        ParticlesBounceFactor: () => Be,
        ParticlesDensity: () => Qe,
        ParticlesInteractorBase: () => Fi,
        ParticlesNumber: () => Ke,
        ParticlesOptions: () => ui,
        Point: () => bi,
        Range: () => wi,
        RangedAnimationOptions: () => Ie,
        RangedAnimationValueWithRandom: () => Ae,
        Rectangle: () => xi,
        ResizeEvent: () => ye,
        Responsive: () => ke,
        RgbColorManager: () => Ai,
        ...
        calcPositionOrRandomFromSize: () => B,
        calcPositionOrRandomFromSizeRanged: () => F,
        calculateBounds: () => it,
        circleBounce: () => lt,
        ...
        getLinkColor: () => Ut,
        getLinkRandomColor: () => $t,
        getLogger: () => $,
        getParticleBaseVelocity: () => E,
        getParticleDirectionAngle: () => D,
        getPosition: () => mt,
        getRandom: () => _,
        getRandomRgbColor: () => qt,
        getRangeMax: () => S,
        getRangeMin: () => P,
        getRangeValue: () => C,
        getSize: () => gt,
    ...
    function T(t) {
      const e = t.random,
        { enable: i, minimumValue: s } = yt(e)
          ...
          : e;
      return C(i ? O(t.value, s) : t.value);
    }
    function R(t, e) {
      const i = t.x - e.x,
        s = t.y - e.y;
    ...
    function U(t) {
      (W.debug = t.debug || W.debug),
        (W.error = t.error || W.error),
        (W.info = t.info || W.info),
        (W.log = t.log || W.log),
        (W.verbose = t.verbose || W.verbose),
        (W.warning = t.warning || W.warning);
    }
    function $() {
      return W;
    }
    ...
    function Tt(t, e, i = !0) {
      ...
      if (bt(s.value)) return Rt(s.value, e, i);
      if (kt(s.value)) return Tt({ value: K(s.value, e, i) });
      for (const [, t] of Ct) {
    ...
    function Rt(t, e, i = !0) {
      if (!t) return;
      const s = bt(t) ? { value: t } : t;
      if (bt(s.value)) return s.value === Mt ? qt() : At(s.value);
      if (kt(s.value)) return Rt({ value: K(s.value, e, i) });
      for (const [, t] of Ct) {
    ...
    function qt(t) {
      const e = t ?? 0;
      return {
        b: Math.floor(z(O(e, 256))),
        g: Math.floor(z(O(e, 256))),
        r: Math.floor(z(O(e, 256))),
      };
    }
    function Vt(t, e) {
    ...
    function Ut(t, e, i) {
      ...
      if (i !== zt) return i;
      {
        ...
        if (i && s && e) return Wt(i, s, t.getRadius(), e.getRadius());
        {
          const t = i ?? s;
          if (t) return Bt(t);
        }
    ...
    function jt(t, e, i) {
      ...
      return e && (Nt(s.h, e.h, i), Nt(s.s, e.s, i), Nt(s.l, e.l, i)), s;
    }
    function Nt(t, e, i) {
      (t.enable = e.enable),
        t.enable
        ...
        (this.container = t),
          ...
          (this._getPluginParticleColors = (t) => {
            ...
            for (const s of this._colorPlugins)
              if (
                (!e && s.particleFillColor && (e = Dt(s.particleFillColor(t))),
                !i &&
                  s.particleStrokeColor &&
                  (i = Dt(s.particleStrokeColor(t))),
                e && i)
              )
                break;
            return [e, i];
          ...
          (this._paintBase = (t) => {
            this.draw((e) => Jt(e, this.size, t));
          }),
          (this._paintImage = (t, e) => {
            this.draw((i) => Zt(i, this.size, t, e));
          }),
          (this._repairStyle = () => {
            const t = this.element;
            t &&
          ...
          (n || a) &&
            this.draw((s) => {
              const o = this.container,
                ...
                p = {},
                f = { fill: n ? Ht(n, d) : void 0 };
              (f.stroke = a ? Ht(a, u) : f.fill),
      ...
      paint() {
        ...
        this.draw((e) => {
          t.backgroundMask.enable && t.backgroundMask.cover
            ? (Qt(e, this.size), this._paintBase(this._coverColorStyle))
            : this._paintBase();
        });
      }
      resize() {
          ...
          (this._manageInteractivityListeners = (t, e) => {
            ...
            f && (f.style.pointerEvents = p === f ? "initial" : "none"),
              (a.interactivity.events.onHover.enable ||
                ...
                re(u, c, i.touchStart, e),
                re(u, h, i.touchMove, e),
                a.interactivity.events.onClick.enable
                  ? (re(u, l, i.touchEndClick, e),
                    re(u, o, i.mouseUp, e),
    ...
    class he {
      ...
      load(t) {
        t &&
          (void 0 !== t.color && (this.color = le.create(this.color, t.color)),
    ...
    class Ee {
      constructor() {
        (this.random = new De()), (this.value = 0);
      }
      load(t) {
        t &&
          (yt(t.random)
    ...
    class Fe {
      constructor() {
        (this.horizontal = new Be()), (this.vertical = new Be());
      }
      load(t) {
        t &&
    ...
    class Ke {
      constructor() {
        (this.density = new Qe()), (this.limit = 0), (this.value = 0);
      }
      get max() {
        return this.limit;
      }
    ...
    class ti {
      ...
      load(t) {
        t &&
          ...
          (this.color = le.create(this.color, t.color)),
          void 0 !== t.enable && (this.enable = t.enable),
          void 0 !== t.offset &&
    ...
    class hi {
      ...
      load(t) {
        t &&
          (void 0 !== t.color && (this.color = Se.create(this.color, t.color)),
    ...
    class ui {
      ...
      load(t) {
        ...
        if (
          (this.bounce.load(t.bounce),
          this.color.load(Se.create(this.color, t.color)),
          void 0 !== t.groups)
        )
    ...
    class yi {
      constructor(t, e, i, s, o, n) {
        (this.container = i),
          ...
          (this._calculateVelocity = () => {
            ...
            return (
              e.straight || (t.angle += z(O(o.left, o.right))),
          ...
          (this._checkOverlap = (t, e = 0) => {
            ...
            return !!this.container.particles.find(
              (e) => I(t, e.position) < s + e.getRadius()
            );
          }),
      ...
      init(t, e, i, s) {
        ...
        const a = o.retina.pixelRatio,
          r = o.actualOptions,
          c = fi(this._engine, o, r.particles),
          l = c.shape.type,
    ...
    class _i extends wi {
      ...
      contains(t) {
        return I(t, this.position) <= this.radius;
      }
      intersects(t) {
      ...
      query(t, e, i) {
        ...
        for (const i of this._points)
          (!t.contains(i.position) &&
            I(t.position, i.position) > i.particle.getRadius() &&
            (!e || e(i.particle))) ||
            s.push(i.particle);
    ...
    class zi {
      constructor(t, e) {
        (this._applyDensity = (t, e, i) => {
          ...
          (this.needsSort = !1),
          (this.lastZIndex = 0),
          (this._interactionManager = new mi(t, e));
        const i = e.canvas.size;
        (this.quadTree = new ki(Mi(i), 4)),
      ...
      async update(t) {
        const e = this._container,
          i = new Set();
        this.quadTree = new ki(Mi(e.canvas.size), 4);
        ...
        for (const s of this._array) {
          ...
          s.destroyed
            ? i.add(s)
            : this.quadTree.insert(new bi(s.getPosition(), s));
        }
        if (i.size) {
          const t = (t) => !i.has(t);
    ...
    class Ti {
      constructor(t, e, i) {
        (this.id = e),
          ...
          (this.particles = new zi(this._engine, this)),
          (this.pathGenerators = new Map()),
          (this.interactivity = { mouse: { clicking: !1, inside: !1 } }),
          (this.plugins = new Map()),
          (this.drawers = new Map()),
          (this._options = Si(this._engine, this)),
          (this.actualOptions = Si(this._engine, this)),
          (this._eventListeners = new ce(this)),
      ...
      addPath(t, e, i = !1) {
        return (
          !(!Pi(this) || (!i && this.pathGenerators.has(t))) &&
          (this.pathGenerators.set(t, e ?? Oi), !0)
        );
      }
      alive() {
      ...
      async init() {
        ...
        (this._options = Si(
          ...
          (this.actualOptions = Si(this._engine, this, this._options));
    ...
    class Di {
      ...
      getInteractors(t, e = !1) {
        return Ii(t, this.interactors, this._initializers.interactors, e);
      }
      getMovers(t, e = !1) {
        return Ii(t, this.movers, this._initializers.movers, e);
      }
      getPathGenerator(t) {
      ...
      getUpdaters(t, e = !1) {
        return Ii(t, this.updaters, this._initializers.updaters, e);
      }
      loadOptions(t, e) {
    ...
    class Ei {
      constructor() {
        (this._configs = new Map()),
          (this._domArray = []),
          (this._eventDispatcher = new Ri()),
          (this._initialized = !1),
          (this.plugins = new Di(this));
      }
      get configs() {
        const t = {};
      ...
      async addShape(t, e, i, s, o, n = !0) {
        ...
        yt(i) ? ((h = i), (r = void 0)) : (r = i),
          yt(s) ? ((h = s), (c = void 0)) : (c = s),
          yt(o) ? ((h = o), (l = void 0)) : (l = o),
    ...
    class Li {
      ...
      handleColor(t) {
        ...
        if (void 0 !== e.h && void 0 !== e.s && void 0 !== e.l) return Bt(e);
      }
      handleRangeColor(t) {
        const e = t.value.hsl ?? t.value;
        if (void 0 !== e.h && void 0 !== e.l)
          return Bt({ h: C(e.h), l: C(e.l), s: C(e.s) });
      }
      parseString(t) {
    ...
    const Hi = (t) => {
      ...
      return (
        ...
        (window.pJSDom = i),
        (window.Particles = Vi),
        { particlesJS: e, pJSDom: i, Particles: Vi }
      );
    };
    function Wi(t, e, i, s, o, n) {
      !(function (t, e) {
        const i = t.options,
          s = i.move.path;
        if (!s.enable) return;
    ...
    class Ui {
      ...
      move(t, e) {
        ...
        const o = t.container,
          ...
          c = (t.retina.moveDrift ??= C(t.options.move.drift) * n),
          l = S(i.size.value) * n,
    ...
    class ji {
      ...
      init(t) {
        const e = Dt(t.options.color, t.id, t.options.reduceDuplicates);
        e &&
          (t.color = jt(
            e,
        ...
        switch (t.outType) {
          case "inside": {
            ...
            (t.position.x = Math.floor(
              z({ min: 0, max: o.canvas.size.width })
            )),
              (t.position.y = Math.floor(
                z({ min: 0, max: o.canvas.size.height })
              ));
          ...
          default:
            ...
            switch (t.outType) {
              case "outside": {
                (t.position.x =
                  Math.floor(
                    z({ min: -t.moveCenter.radius, max: t.moveCenter.radius })
                  ) + t.moveCenter.x),
                  (t.position.y =
                    Math.floor(
                      z({ min: -t.moveCenter.radius, max: t.moveCenter.radius })
    ...
    class Qi {
      constructor(t) {
        (this.container = t),
          ...
          (this.updaters = [new Xi(t), new Yi(t), new Zi(t), new Ji(t)]);
      }
      init() {}
      isEnabled(t) {
    ...
    async function ts(t, e = !0) {
      await (async function (t, e = !0) {
        await t.addMover("base", () => new Ui(), e);
      })(t, !1),
        await (async function (t, e = !0) {
          await t.addShape("circle", new $i(), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("color", (t) => new ji(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("opacity", (t) => new Ni(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("outModes", (t) => new Qi(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("size", () => new Ki(), e);
        })(t, !1),
        await t.refresh(e);
    }
    class es {
        ...
        super(e),
          (this._clickAttract = () => {
            ...
            if (
              ...
              if (!i || i < 0 || !e) return;
              this._processAttract(e, i, new _i(e.x, e.y, i));
        ...
        super(t),
          ...
          (this._processMouseBounce = () => {
            ...
            !s ||
              s < 0 ||
              !i ||
              this._processBounce(i, s, new _i(i.x, i.y, s + e));
          }),
      ...
      load(t) {
        if (t) {
          if (
            ...
            this.color = dt(t.color, (t) => le.create(e, t));
          }
          void 0 !== t.size && (this.size = t.size);
        }
      }
        ...
        super(t),
          (this._clickBubble = () => {
            ...
            for (const e of n) {
              ...
              const n = I(e.getPosition(), i),
                r =
                  (new Date().getTime() -
                    (t.interactivity.mouse.clickTime || 0)) /
                  1e3;
              r > s.duration && (a.durationEnd = !0),
                r > 2 * s.duration && ((a.clicking = !1), (a.durationEnd = !1));
              const c = {
                bubbleObj: {
            ...
            if (o) {
              ...
              if (t.bubble.finalColor)
                if (o.mix) {
                  ...
                  t.bubble.color = i
                    ? Et(Wt(i, t.bubble.finalColor, 1 - e, e))
                    : t.bubble.finalColor;
          ...
          (this._hoverBubbleOpacity = (t, e, i) => {
            ...
            const n = t.options.opacity.value,
              a = cs(t.opacity?.value ?? 1, o, S(n), e);
    ...
    class ds {
      constructor() {
        (this.distance = 80), (this.links = new hs()), (this.radius = 60);
      }
      get lineLinked() {
        return this.links;
      }
      ...
      if (o)
        return (function (t, e, i, s) {
          ...
          const r = e.getPosition(),
            c = i.getPosition(),
            l = Wt(n, a, e.getRadius(), i.getRadius()),
            h = t.createLinearGradient(r.x, r.y, c.x, c.y);
          return (
            h.addColorStop(0, Ht(n, s)),
            h.addColorStop(o > 1 ? 1 : o, Vt(l, s)),
            h.addColorStop(1, Ht(a, s)),
            h
          );
    ...
    function ps(t, e, i) {
      t.canvas.draw((s) => {
        ...
        const n = e.getPosition(),
          a = i.getPosition();
        !(function (t, e, i, s, o) {
          Xt(t, s, o), (t.lineWidth = e), (t.strokeStyle = i), t.stroke();
    ...
    class ms {
      constructor() {
        (this.distance = 100), (this.links = new vs());
      }
      get lineLinked() {
        return this.links;
      }
    ...
    function gs(t, e, i, s, o) {
      t.canvas.draw((t) => {
        const n = e.getPosition();
        !(function (t, e, i, s, o, n) {
          Xt(t, i, s),
            (t.strokeStyle = Vt(o, n)),
            (t.lineWidth = e),
            t.stroke();
      ...
      async interact() {
        ...
        for (const n of o) {
          ...
          if (!t.particles.grabLineColor && l) {
            ...
            t.particles.grabLineColor = $t(l, i.blink, i.consent);
          }
          const h = Ut(n, void 0, t.particles.grabLineColor);
          h && gs(t, n, h, c, i);
        }
      }
      isEnabled(t) {
      ...
      constructor(t) {
        super(t),
          (this.handleClickMode = (t) => {
            ...
            const s = C(i.interactivity.modes.remove.quantity);
        ...
        super(e),
          ...
          (this._hoverRepulse = () => {
            ...
            !i ||
              i < 0 ||
              !e ||
              this._processRepulse(e, i, new _i(e.x, e.y, i));
          }),
                  ...
                  for (let t = 0, e = 0; ; ) {
                    ...
                    if (((i = m(r, o)), (r += o + 1), i === v)) {
                      ...
                      for (let s = 0; s < c[i].length; s++) {
                        ...
                        u.data.set(
                          [o, n, r, h],
                          Ts[l] * a.width + Rs[l] * e + (t % (4 * a.width))
                        ),
                          (t += 4);
                      }
                      c.length === 1 << o && o < 12 && o++;
        ...
        try {
          (t.gifData = await (async function (t, e, i) {
            ...
            const o = await s.arrayBuffer(),
              ...
              a = new Is(new Uint8ClampedArray(o));
    ...
    async function Fs(t) {
      if ("svg" !== t.type) return void (await As(t));
      t.loading = !0;
    ...
    function qs(t, e, i, s) {
      const o = (function (t, e, i) {
          ...
          if (!s) return "";
          const o = Ht(e, i);
          if (s.includes("fill")) return s.replace(Ls, () => o);
          const n = s.indexOf(">");
      ...
      return new Promise((e) => {
        ...
        r.addEventListener("load", () => {
          ...
          r.addEventListener("error", async () => {
            ...
            await As(i), (n.loaded = !0), (n.element = i.element), e(n);
          }),
          (r.src = a);
      });
    }
          ...
          if (((t.globalAlpha = s), n.gif && n.gifData)) {
            ...
            switch (
              ...
              case 0:
                ...
                break;
              case 1:
                a.drawImage(l.bitmap, l.left, l.top), t.drawImage(s, c.x, c.y);
                break;
              case 2:
                a.drawImage(l.bitmap, l.left, l.top),
                  t.drawImage(s, c.x, c.y),
    ...
    async function Us(t, e = !0) {
          ...
          (t.loadImage = async (e) => {
            ...
            if (
              ...
              try {
                ...
                t.images.push(i);
                const s = e.gif ? Bs : e.replaceColor ? Fs : As;
                await s(i);
              } catch {
      ...
      await t.addPlugin(i, e),
        await t.addShape(["image", "images"], new Vs(t), e);
    }
    class $s extends Ee {
      constructor() {
        super(), (this.sync = !1);
    ...
    class js {
      constructor() {
        (this.count = 0), (this.delay = new $s()), (this.duration = new Gs());
      }
      load(t) {
        t &&
    ...
    class Xs {
      draw(t, e, i) {
        const s = e.shapeData;
        t.moveTo(-i / 2, 0), t.lineTo(i / 2, 0), (t.lineCap = s?.cap ?? "butt");
      }
      getSidesCount() {
        return 1;
      }
    ...
    const Qs = (t) => {
      void 0 === t.collisionMaxSpeed &&
        (t.collisionMaxSpeed = C(t.options.collisions.maxSpeed)),
        t.velocity.length > t.collisionMaxSpeed &&
          (t.velocity.length = t.collisionMaxSpeed);
    };
    function Ks(t, e) {
      lt(ct(t), ct(e)), Qs(t), Qs(e);
    }
    function to(t, e, i, s) {
      switch (t.options.collisions.mode) {
        case "absorb":
          !(function (t, e, i, s) {
            ...
            void 0 === o && void 0 !== n
              ...
              : void 0 !== o &&
                void 0 !== n &&
                (o >= n ? Zs(t, 0, e, n, i, s) : Zs(e, 0, t, o, i, s));
          })(t, e, i, s);
          break;
        case "bounce":
          Ks(t, e);
        ...
        case "destroy":
          !(function (t, e) {
            t.unbreakable || e.unbreakable || Ks(t, e),
    ...
    class eo extends Fi {
      ...
      async interact(t, e) {
        ...
        for (const a of n) {
          ...
          I(s, n) > o + r || to(t, a, e, i.retina.pixelRatio);
        }
      }
      isEnabled(t) {
    ...
    class io extends _i {
      ...
      intersects(t) {
        ...
        if (void 0 !== i.radius) {
          const t = new _i(s.x, s.y, 2 * i.radius);
          return super.intersects(t);
        }
        if (void 0 !== e.size) {
          const t = new xi(s.x, s.y, 2 * e.size.width, 2 * e.size.height);
          return super.intersects(t);
        }
        return !1;
      }
    ...
    class ro extends Fi {
      ...
      async interact(t) {
        ...
        const o = t.options.links,
          ...
          r = o.warp,
          c = r ? new io(e.x, e.y, a, s) : new _i(e.x, e.y, a),
    ...
    class lo {
      constructor(t) {
        (this.container = t),
            ...
            s.canvas.draw((e) => {
              ...
              !(function (t) {
                ...
                if (I(i, s) <= o) Xt(n, i, s), (e = !0);
                  ...
                  t && r && (Xt(n, i, t), Xt(n, s, r), (e = !0));
                }
                if (!e) return;
                (n.lineWidth = r),
                  c.enable && (n.globalCompositeOperation = c.composite),
                  (n.strokeStyle = Vt(l, h));
                const { shadow: u } = d;
                if (u.enable) {
                  const t = Tt(u.color);
                  t && ((n.shadowBlur = u.blur), (n.shadowColor = Vt(t)));
                }
                n.stroke();
              })({
                context: e,
            ...
            l <= 0 ||
              n.canvas.draw((e) => {
                const i = t.getPosition(),
                  ...
                  d = c.getPosition(),
                  u = t.retina.linksDistance ?? 0;
                if (I(i, h) > u || I(d, h) > u || I(d, i) > u) return;
                let p = Tt(o.color);
                if (!p) {
                  const e =
                    void 0 !== s.id
          ...
          (this._getLinkFrequency = (t, e) => co([t, e], this._freqs.links)),
          (this._getTriangleFrequency = (t, e, i) =>
            co([t, e, i], this._freqs.triangles)),
    ...
    async function uo(t, e = !0) {
      await (async function (t, e = !0) {
        await t.addInteractor("particlesLinks", (t) => new ro(t), e);
      })(t, e),
        await (async function (t, e = !0) {
          const i = new ho();
          await t.addPlugin(i, e);
    ...
    async function mo(t, e = !0) {
      await (async function (t, e = !0) {
        await t.addShape("polygon", new fo(), e);
      })(t, e),
        await (async function (t, e = !0) {
          await t.addShape("triangle", new vo(), e);
        })(t, e);
    }
    class go {
      constructor() {
    ...
    class Mo {
      ...
      init(t) {
        ...
        (t.strokeWidth = C(s.width) * e.retina.pixelRatio),
          (t.strokeOpacity = C(s.opacity ?? 1)),
          (t.strokeAnimation = s.color?.animation);
        const o = Dt(s.color) ?? t.getFillColor();
        o && (t.strokeColor = jt(o, t.strokeAnimation, e.retina.reduceFactor));
      }
      isEnabled(t) {
    ...
    class Co {
      ...
      async init(t) {
        const e = t.actualOptions;
        if (zo.find((t) => J(t, e.particles.shape.type))) {
          const t = zo
      ...
      particleInit(t, e) {
        if (!e.shape || !zo.includes(e.shape)) return;
        const i = e.shapeData;
        if (void 0 === i) return;
        const s = i.value;
    ...
    async function Po(t, e = !0) {
      Hi(t),
        await (async function (t, e = !0) {
          await t.addMover("parallax", () => new Ys(), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalAttract", (e) => new is(t, e), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalBounce", (t) => new os(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalBubble", (t) => new ls(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalConnect", (t) => new fs(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalGrab", (t) => new ys(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalPause", (t) => new bs(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalPush", (t) => new xs(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalRemove", (t) => new ks(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalRepulse", (e) => new Ps(t, e), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalSlow", (t) => new Os(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("particlesAttract", (t) => new Js(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("particlesCollisions", (t) => new eo(t), e);
        })(t, !1),
        await uo(t, !1),
        ...
        await Us(t, !1),
        await (async function (t, e = !0) {
          await t.addShape("line", new Xs(), e);
        })(t, !1),
        await mo(t, !1),
        await (async function (t, e = !0) {
          await t.addShape(["edge", "square"], new xo(), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addShape("star", new _o(), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addShape(zo, new Co(), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("life", (t) => new Ns(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("rotate", (t) => new bo(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("strokeColor", (t) => new Mo(t), e);
        })(t, !1),
        await ts(t, e);
    }
    return Po(qi), e;
